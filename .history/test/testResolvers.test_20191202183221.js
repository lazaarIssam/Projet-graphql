...
describe("Queries & Mutations", () => {
    ...
    test("Should be a valid createQuestion mutation", () => {
      const mutation = `{
        mutation createQuestion($annonceId:ID, $questionInput:{$title: String, $date:String, $description:String}) {
          createQuestion (annonceId:5de1bc3084f6911ed8e27711) {
            title
          }
        }}
      `;
      tester.test(true, mutation, [{
        questionInput:{title: "test",
        date: "2019-11-22T11:14:46.131Z",
        description: "test",
