...
mongoose.connect(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD
    }cluster0-r1skt.mongodb.net/${process.env.MONGO_DB}?retryWrites=true`
  )
  .then(() => {
    app.listen(3000);
  })
...
//mongodb+srv://admin:<password>@cluster0-r1skt.mongodb.net/test?retryWrites=true&w=majority
